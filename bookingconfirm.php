...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="container">
            <h1 class="text-center text-success">Booking Confirmed!</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center alert alert-success" role="alert">Thank you! for choosing Car Rental!</h2>

    <div class="container">
        <h5 class="text-center text-success">Please read the following information about your rental!</h5>
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 class="text-warning">Your booking has been received and placed into order processing system.</h3>
                <br>
            ...
            <div class="col-md-10 " style="float: none; margin: 0 auto; ">
                ...
                if($charge_type == "days"){
                ?>
                     <h4 class="text-success"> <strong>Fare:</strong> Ksh. <?php echo $fare; ?>/day</h4>
                <?php } else {
                    ?>
                    <h4 class="text-success"> <strong>Fare:</strong> Ksh. <?php echo $fare; ?>/km</h4>
                ...
                <br>
                <h4 class="text-success"> <strong>Return Date: </strong> <?php echo $rent_end_date; ?></h4>
                <br>
                <h4 class="text-success"> <strong>Driver Name: </strong> <?php echo $driver_name; ?> </h4>
                <br>
                <h4 class="text-success"> <strong>Driver Gender: </strong> <?php echo $driver_gender; ?> </h4>
                <br>
                <h4 class="text-success"> <strong>Driver License number: </strong>  <?php echo $dl_number; ?> </h4>
                <br>
                <h4 class="text-success"> <strong>Driver Contact:</strong>  <?php echo $driver_phone; ?></h4>
                <br>
                <h4 class="text-success"> <strong>Employee Name:</strong>  <?php echo $client_name; ?></h4>
                <br>
                <h4 class="text-success"> <strong>Employee Contact: </strong> <?php echo $client_phone; ?></h4>
                <br>
            </div>
        </div>
