    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
        ...
        ?>
          ...
          <!-- <div class="form-group"> -->
              <h5 class="text-success"> Selected Car:&nbsp;  <b><?php echo($car_name);?></b></h5>
         <!-- </div> -->
         
          <!-- <div class="form-group"> -->
            <h5 class="text-success"> Number Plate:&nbsp;<b> <?php echo($car_nameplate);?></b></h5>
          <!-- </div>      -->
        <!-- <div class="form-group"> -->
        <?php $today = date("Y-m-d") ?>
          <label><h5 class="text-success">Start Date:</h5></label>
            <input type="date" name="rent_start_date" min="<?php echo($today);?>" required>
            &nbsp; 
          <label><h5 class="text-success">End Date:</h5></label>
        ...
        <div ng-switch-default>
                    <!-- <div class="form-group"> -->
                <h5 class="text-success">Fare: <h5>    
                <!-- </div>    -->
                     </div>
                    <div ng-switch-when="ac">
                    <!-- <div class="form-group"> -->
                <h5 class="text-success">Fare: <b><?php echo("Ksh. " . $ac_price . "/km and Ksh. " . $ac_price_per_day . "/day");?></b><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5 class="text-success">Fare: <b><?php echo("Ksh. " . $non_ac_price . "/km and Ksh. " . $non_ac_price_per_day . "/day");?></b><h5>    
                <!-- </div>   -->
                     </div>
        </div>

         <h5 class="text-success"> Charge type:  &nbsp;
            ...
            <br><br>
                ...
                <div ng-switch-when="<?php echo($driver_id); ?>">
                    <h5 class="text-success">Driver Name:&nbsp; <b><?php echo($driver_name); ?></b></h5>
                    <p class="text-success">Gender:&nbsp; <b><?php echo($driver_gender); ?></b> </p>
                    <p class="text-success">Contact:&nbsp; <b><?php echo($driver_phone); ?></b> </p>
                </div>
                <?php }} ?>
                </div>
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6 class="text-danger"><strong>Note:</strong> You will be charged with extra <span class="text-danger">ksh. 500</span> for each day after the due date ends.</h6>
        </div>
    </div>
